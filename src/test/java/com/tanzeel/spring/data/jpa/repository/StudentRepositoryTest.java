...
class StudentRepositoryTest {
    ...
    public void getStudentByEmailAddress() {
        Student student = studentRepository.findStudentByEmailAddress("001tanzeel@gmail.com");
        System.out.println("Student: " + student);
    }

    @Test
    public void getStudentFirstNameByEmailAddress() {
        String studentFirstName = studentRepository.findStudentFirstNameByEmailAddress("001tanzeel@gmail.com");
        System.out.println("Student's FirstName: " + studentFirstName);
    }

    @Test
    public void findStudentByEmailAddressNative() {
        Student student = studentRepository.findStudentByEmailAddressNative("001tanzeel@gmail.com");
        System.out.println("Student: " + student);
    }

    @Test
    public void findStudentByEmailAddressNativeNamedParam() {
        Student student = studentRepository.findStudentByEmailAddressNativeNamedParam("001tanzeel@gmail.com");
        System.out.println("Student: " + student);
    }

    @Test
    public void updateStudentNameByEmailIdTest() {
        int res = studentRepository.updateStudentNameByEmailId("Sam","test@gmail.com");
